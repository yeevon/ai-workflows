...
3. **(G3)** At least one new productivity command lands as a Skill (`/triage` recommended). Spec covers full set; M21 ships at minimum the highest-value surface. (satisfied at T13 with /triage; T14 adds /check; T16 adds /sweep; T15 separate)
