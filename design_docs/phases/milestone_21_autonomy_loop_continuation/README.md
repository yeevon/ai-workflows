...
3. **(G3)** At least one new productivity command lands as a Skill (`/triage` recommended). Spec covers full set; M21 ships at minimum the highest-value surface. (satisfied at T13; /triage shipped as the highest-value Phase F Skill; T14/T15/T16 separate)
